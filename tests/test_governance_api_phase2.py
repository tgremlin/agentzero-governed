...
def test_system_trace_returns_materialized_items(monkeypatch):
    ...
    monkeypatch.setattr(
        ...
        lambda project_name="": {
            ...
            "dataset_summary": {"total_records": 10, "total_gold": 2, "gold_yield": 0.2, "latest_generated_at": None},
            "decision_summary": {"by_decision": {"trigger": 1}, "latest_generated_at": None},
            "lifecycle_summary": {"stage_status_counts": {}, "active_run_count": 0, "latest_generated_at": None},
        },
    )
    ...
    assert out["count"] == 2
    assert out["total"] == 2
    assert out["summary"]["dataset_summary"]["total_records"] == 10
